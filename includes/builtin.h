...
/*   Updated: 2024/03/24 15:38:58 by yothmani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			process_export_with_assignment(t_command *info,
					t_cmd_parse *cmd, int index);
void			process_export_without_assignment(t_command *info,
					t_cmd_parse *cmd, int index);
